...
- **날짜 기간 설정**: 매주 반복은 시작일~완료일 범위 지정, 1회 알림은 특정 날짜 지정
...
1. **미팅 추가**: "미팅 추가" 버튼 클릭 후 이름, 요일, 시간, 알림 시간 입력
   - **매주 반복** 체크: 매주 해당 요일마다 반복 알림 / 시작일~완료일 범위 설정
   - **매주 반복** 해제: 알림 요청일 지정, 해당 날짜 1번만 알림 후 자동 완료 처리
...
### v1.0.3
- 자동 업데이트 기능 추가: 설정 창에서 현재/최신 버전 확인 및 업데이트 버튼으로 자동 설치

### v1.0.2
- 미팅 날짜 기간 설정 기능 추가
  - 매주 반복 미팅: 시작일 ~ 완료일 범위 지정, 해당 기간에만 알림 발동
  - 1회 알림 미팅: 알림 요청일 지정, 해당 날짜에만 정확히 발동 (요일 자동 설정)
- 1회 알림 완료 후 목록 글자 크기 버그 수정
